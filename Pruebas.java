...
public class Pruebas {
    ...
    public static void fusionar(int[] arr, int inicio, int medio, int fin) {
        // Encuentra el tamano de los subarreglos para fusionarlos
        ...
        // Indice inicial del subarreglo fusionado
        int k = inicio;
        while (i < n1 && j < n2) {
            if (izq[i] <= der[j]) {
                arr[k] = izq[i];
    ...
    public static void heapsort(int[] arr) {
        ...
        // Construir el montIculo (reorganizar el arreglo)
        ...
        for (int i=n-1; i>0; i--) {
            ...
            // llamar a la función heapify en el montIculo reducido
            heapify(arr, i, 0);
        }
    }
    
    public static void heapify(int[] arr, int n, int i) {
        int max = i; // Inicializa max como raIz
